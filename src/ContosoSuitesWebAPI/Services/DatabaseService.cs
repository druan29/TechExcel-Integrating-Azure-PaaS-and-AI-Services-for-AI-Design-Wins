...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for a single hotel and minimalDate.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate( [Description("The ID of the hotel")] int hotelId, [Description("The Minimal Date of the hotel")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all bookings that with more than one hotel room")]
